...
struct FirestoreConstants {
    static let RepliesCollection = Firestore.firestore().collection("replies")
    static let ThreadCollection = Firestore.firestore().collection("threads")
    // Add more Firestore collections or constants as needed
}

struct CapReplyService {
    static func uploadCapReply(_ reply: CapReply, forThread thread: Thread) async throws {
